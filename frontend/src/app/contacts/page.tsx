...
export default function ContactsPage() {
  return (
    <main className="bg-white text-[#333]">
        ...
        <div className="max-w-350 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div>
            ...
            >
              ...
              <a
                href="tel:0507680483"
                className="text-3xl md:text-5xl font-black no-underline block mb-2"
                style={{ color: "#f16a9e" }}
              >
                050 768-04-83
              </a>
      ...
      {/* Карта */}
      <section className="w-full h-80 md:h-100 mt-4 flex items-center justify-center text-center text-[#666]"
